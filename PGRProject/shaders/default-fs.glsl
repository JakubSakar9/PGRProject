...
vec3 computeDiffuse(vec3 pointLightContributions[c_maxPointLights],
...
vec3 computeSpecular(vec3 pointLightContributions[c_maxPointLights],
					 vec3 pointLightDirections[c_maxPointLights],
					 vec3 spotlightContributions[c_maxSpotlights],
					 vec3 spotlightDirections[c_maxSpotlights],
					 vec3 normal) {
